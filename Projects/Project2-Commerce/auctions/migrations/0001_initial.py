...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='listing',
            index=models.Index(fields=['is_active', 'category', '-created_at'], name='idx_active_cat_created'),
        ),
        migrations.AddConstraint(
            model_name='listing',
            constraint=models.CheckConstraint(condition=models.Q(('starting_bid__gte', Decimal('0.10'))), name='listing_starting_bid_min_010'),
        ),
        migrations.AddConstraint(
            model_name='listing',
            constraint=models.CheckConstraint(condition=models.Q(('is_active', True), ('closed_time__isnull', False), _connector='OR'), name='listing_closed_requires_time'),
        ),
    ]
